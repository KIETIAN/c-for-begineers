...
<div id="submission-app" style="margin-top: 20px" class="container" ng-app="app">
  <div class="row" ng-controller="BaseCtrl as baseCtrl">
    <div class="col-md-12">
        ...
        <h4><a class="inline-wrap" href="/problems/first-bad-version/">First Bad Version</a></h4>
...
<div id="result-testcases-panel" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <td>
          <div id="submitted-time">Submitted: <strong><span id="result_date">1 day, 10 hours ago</span></strong></div>
        </td>
        </tr>
        </table>
      </div>
      ...
      <div id="content" class="placeholder-content hide" ng-show="statusText === 'Accepted'">
        ...
        <br>
          ...
          <div class="animated fadeInLeft">
            <h4><small>Invite friends to challenge <b>First Bad Version</b></small></h4>
            
            <div
              class="addthis_sharing_toolbox"
              data-title="#LeetCode# I have solved First Bad Version. Come and join the fun!"
              data-url="leetcode.com/problems/first-bad-version/">
            </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <h4>Submitted Code: <strong><span id="result_date" class="h5">1 day, 10 hours ago</span></strong></h4>
          <div class="row">
            <div class="col-md-12">
              <div class="pull-left">Language: <span id="result_language">c</span></div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="text-center">
                  <a href="/problems/first-bad-version/">Back to problem</a>
                </div>
              </div>
            </div>
...
var pageData = {
  ...
  questionId: '278',
  submissionId: '767329160',
  sessionId: '7069838',
  getLangDisplay: 'c',
  submissionCode: 'int firstBadVersion(int n) {\u000A    int left \u003D 1\u003B\u000A    int right \u003D n\u003B\u000A    \u000A    while(left\u003Cright){\u000A       int mid \u003D left + (right\u002Dleft)/2\u003B\u000A        \u000A        if(isBadVersion(mid)){\u000A            right \u003D mid\u003B\u000A        }\u000A        else{\u000A            left \u003D mid + 1\u003B \u000A        }\u000A    }\u000A    return left\u003B\u000A}',
  editCodeUrl: '/problems/first-bad-version/',
  checkUrl: '/submissions/detail/767329160/check/',
  runtimeDistributionFormatted: '{\u0022lang\u0022: \u0022c\u0022, \u0022distribution\u0022: [[\u00220\u0022, 45.2344], [\u00221\u0022, 1.5625], [\u00222\u0022, 7.6562], [\u00223\u0022, 14.375], [\u00224\u0022, 8.2812], [\u00225\u0022, 7.8125], [\u00226\u0022, 6.7188], [\u00227\u0022, 2.7344]]}',
  memoryDistributionFormatted: '{\u0022lang\u0022: \u0022c\u0022, \u0022distribution\u0022: [[\u00225300\u0022, 1.5625], [\u00225400\u0022, 33.5156], [\u00225500\u0022, 20.7031], [\u00225600\u0022, 24.9219]]}',
  langs: [
